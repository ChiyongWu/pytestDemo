...
from utils.allure_util.allure_report_data import CaseCount
from utils.time_util import now_time
from utils.local_ip_util import get_host_ip
from config.config_processor import config_processor
...
class WeChatSend:
    ...
    企业微信消息通知
    """
    project_name = config_processor.project_name
    tester_name = config_processor.tester_name
    webhook = config_processor.WeChat.webhook

    def __init__(self):
        self.curl = WeChatSend.webhook
    ...
    def send_wechat_notification(self):
        ...
        text = """【{0}自动化通知】
            ...
            .format(WeChatSend.tester_name, self.RATE, self.TOTAL, self.PASS, self.FAILED,
